import 'package:t_store/features/shop/checkout/model/payment_intent_model/amount_details.dart';
import 'package:t_store/features/shop/checkout/model/payment_intent_model/automatic_payment_methods.dart';
import 'package:t_store/features/shop/checkout/model/payment_intent_model/payment_method_options.dart';
...
class PaymentIntentModel {
  ...
  PaymentIntentModel.fromJson(dynamic json) {
    id = json['id'];
    object = json['object'];
    amount = int.parse((json['amount'] ?? 0).toString()) ;
